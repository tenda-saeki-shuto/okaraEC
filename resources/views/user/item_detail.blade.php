...
<body>
    ...
    <div class="container mx-auto p-4">
        {{-- 商品詳細このコメントアウトを消して、下のデモを削除してください
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <ul class="list-disc pl-5 mb-4">
                <li>エネルギー: {{$item->energy}}kcal</li>
                <li>タンパク質: {{$item->protein}}g</li>
                <li>脂質: {{$item->fat}}g</li>
                <li>炭水化物: {{$item->carb}}g</li>
                <li>食物繊維: {{$item->fiber}}g</li>
                <li>食塩相当量: {{$item->salt_eqv}}mg</li>
            </ul>
