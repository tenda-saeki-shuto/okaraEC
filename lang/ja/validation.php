...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'regex' => 'カード番号は半角数字で入力してください。',
        'digits_between' => 'カード番号は13〜19桁で入力してください。',
        ],
        'cvc' => [
        ...
        'postal_code'=> [
            ...
            'digits' => '郵便番号は7桁の数字で入力してください。'
        ],
        'prefecture_id'=> [
            'required' => '都道府県を選択してください。',
            'exists' => '選択された都道府県は無効です。'
        ],
        'address'=> [
            'required' => '住所は必須項目です。',
        ],
        'tel'=> [
            ...
            'regex' => '電話番号はハイフンなしで10桁または11桁の数字で入力してください。'
        ],
        'password' => [
